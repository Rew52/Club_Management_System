...
namespace ASM2DDD
{
    public partial class User_V_Club : Form
    {
        ...
        private void User_V_Club_Load(object sender, EventArgs e)
        {
        ...
        private void btResert_Click(object sender, EventArgs e)// After clicking "Refresh" the program will run the following commands.
        {
            ...
            // Create command.
            cmd.CommandText = "SELECT Club.sName,Student.sfullName,Admin.aFullName, Club.cPublicDate FROM" +
                " Club,Admin,Student where Club.cManager = Student.sID and Club.cCreator = Admin.aID";
        ...
        private void btSearch_Click(object sender, EventArgs e)// After clicking "Search" the program will run the following commands.
        {
            try
            {
                ...
                // Create command
                cmd.CommandText = "SELECT Club.sName,Student.sfullName,Admin.aFullName, Club.cPublicDate FROM" +
                " Club,Admin,Student where Club.cManager = Student.sID and Club.cCreator = Admin.aID AND " +
                " sName like @sName or aFullName like @aFullName or sID like @sID or sfullName like @sfullName";
                ...
                cmd.Parameters.AddWithValue("sID", string.Format("%{0}%", txtSearch.Text));
