...
namespace ASM2DDD
{
    public partial class User_V_Event : Form
    {
        ...
        private void User_V_Event_Load(object sender, EventArgs e)
        {
        ...
        private void btResert_Click_1(object sender, EventArgs e)// After clicking "Refresh" the program will run the following commands.
        {
            // Open connection
            conn = new SqlConnection(sqlconnect);
            conn.Open();
            ...
            // Create command.
            cmd.CommandText = "Select Event.eName,Admin.aFullName,Event.eLocation,Event.eDay From " +
                "Event,Admin where Event.eCreator = Admin.aID";
        ...
        private void btSearch_Click(object sender, EventArgs e)// After clicking "Search" the program will run the following commands.
        {
            try
            {
                ...
                // Create command
                cmd.CommandText = "Select Event.eName,Admin.aFullName,Event.eLocation,Event.eDay From " +
                "Event,Admin where Event.eCreator = Admin.aID and eName like @eName or " +
                "aFullName like @aFullName OR eLocation like @eLocation";
